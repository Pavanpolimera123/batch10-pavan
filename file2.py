...
# A variable is conisder to be constant when it is defines
# in caps
...
# age = int(input("enter the age: "))
  ...
  if age>=18 and nationality=="indiam":
